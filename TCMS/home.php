...
<html lang="en">
<head>
<title>Welcome to TMS, UiTMCK</title>
<meta charset="UTF-8">
...
<nav class="w3-sidebar w3-red w3-collapse w3-top w3-large w3-padding" style="z-index:3;width:300px;font-weight:bold;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#AIS committee" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">AIS Committee</a> 
    <a href="#activities" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Activities</a> 
    <a href="#photos" onclick="w3_close()" class="w3-bar-item w3-button w3-hover-white">Photos</a> 
...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" style="margin-top:80px" id="showcase">
    <center><h3>Welcome: <?php echo $row['name']; ?>  | <a href="logout.php">Log out |</a> </h3></center>
	 <div class="reminder"> |
