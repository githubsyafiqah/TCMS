...
if (isset($_POST["submit"])) {
   ...
   $sql = "INSERT INTO 'Contact'('contact_id', 'contact_name', 'contact_studid', 'contact_phone', 'contact_email','contact_desc') VALUES ('contact_id''$contact_name','$contact_studid','$contact_phone', $contact_email','$contact_desc')";

   $result = mysqli_query($conn, $sql);
   if ($result) {
      header("Location: add_contact.php=New record created successfully");
   } else {
...
<head>
   ...
   <title>PHP CRUD (TCMS) Application</title>
</head>

<body>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #00ff5573;">
     Contact Us Form for Taekwando Club Mangement System
   </nav>
