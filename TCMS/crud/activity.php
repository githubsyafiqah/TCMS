...
<head>
  ...
  <title>Taekwando Club Management System (TCMS</title>
</head>

<body>
  <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #9999ff;">
   Taekwando Club Management System (TCMS)
  </nav>
   <nav class="navbar navbar-light justify-content-center fs-3 mb-5" style="background-color: #b2b2ff;">
<h5>| <a href="index.php">Home </a>| <a href="club.php">Club </a>| <a href="membership.php">Membership</a> | <a href="activity.php">Activities </a> | <a href="contact.php">Contact Us</a> | </h5></p>
  ...
  <div class="container">
    ...
    ?>
	<p align="center"><h3>Activities form for Taekwando Club Management System (TCMS)</h3></p>
